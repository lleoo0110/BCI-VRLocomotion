...
namespace EmotivUnityPlugin
{
    ...
    public class EmotivUnityItf
    {
        ...
        // メンタルコマンド
        public static string MentalAction;
        public static double MentalPower;
        // 表情コマンド
        public static string EyeAction;
        public static string UpperAction;
        public static double UpperPower;
        public static string LowerAction;
        public static double LowerPower;
        // 加速度値
        public static double AccelerationX;
        public static double AccelerationY;
        public static double AccelerationZ;
        // パフォーマンスメトリック
        ...
        public static double CognitiveStress;
        ...
        private void OnPerfDataReceived(object sender, ArrayList e)
        {
            ...
            UnityEngine.Debug.Log(dataText);
            // パフォマンスメトリック
            Attention = Convert.ToDouble(e[2]);
            CognitiveStress = Convert.ToDouble(e[4]);
            Debug.Log("Attention: " + Attention);
            Debug.Log("CognitiveStress: " + CognitiveStress);
            /*
            Engagement = Convert.ToDouble(e[2]);
            Excitement = Convert.ToDouble(e[4]);
            Relaxation = Convert.ToDouble(e[7]);
            Stress = Convert.ToDouble(e[9]);
            Interest = Convert.ToDouble(e[11]);
            Focus = Convert.ToDouble(e[13]);
            Attention = Convert.ToDouble(e[15]);
            CognitiveStress = Convert.ToDouble(e[17]);
            */
        }
        ...
        private void OnMotionDataReceived(object sender, ArrayList e)
        {
            ...
            UnityEngine.Debug.Log(dataText);
            // 加速度値
            AccelerationX = Convert.ToDouble(e[0]);
            AccelerationY = Convert.ToDouble(e[1]);
            AccelerationZ = Convert.ToDouble(e[2]);
        }
        ...
        private void OnMentalCommandReceived(object sender, MentalCommandEventArgs data)
        {
            ...
            UnityEngine.Debug.Log(dataText);
            // メンタルコマンド識別
            MentalAction = data.Act;
            MentalPower = data.Pow;
        }
        ...
        private void OnFacialExpReceived(object sender, FacEventArgs data)
        {
            ...
            UpperPower = data.UPow;
            LowerAction = data.LAct;
            LowerPower = data.LPow;
        }
